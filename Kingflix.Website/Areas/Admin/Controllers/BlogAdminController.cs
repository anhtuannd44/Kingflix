...
namespace Kingflix.Website.Areas.Admin.Controllers
{
    public class BlogAdminController : Controller
    {
        ...
        {
            var model = _blogService.GetBlogList();
            return View(model);
        }

        public ActionResult Create()
        {
            ViewBag.BlogCategoryId = new SelectList(_blogService.GetBlogCategoryList(), "BlogCategoryId", "Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Title,Url,Description,MetaDescription,MetaKeyword,BlogContent,ImageId,BlogCategoryId,Status")] Blog blog)
        {
            ...
            ViewBag.BlogCategoryId = new SelectList(_blogService.GetBlogCategoryList(), "BlogCategoryId", "Name", blog.BlogCategoryId);
            return View(blog);
        }

        // GET: Admin/BlogAdmin/Edit/5
        ...
        {
            return View(_blogService.GetBlogCategoryList().ToList());
        }
        ...
        public ActionResult CreateBlogCategory(string BlogCategoryName)
        {
            ...
            try
            {
                _blogService.CreateBlogCategory(BlogCategoryName, BlogType.Blog);
                result.status = "success";
        ...
        public ActionResult EditBlogCategory(int BlogCategoryId, string BlogCategoryNameEdit)
        {
            ...
            try
            {
                ...
                result.status = "success";
                result.message = "Thành công! Đã chỉnh sửa danh mục bài viết.";
            }
            catch
            {
                result.status = "error";
